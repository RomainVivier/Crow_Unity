...
public class BuildingGenerator : MonoBehaviour {
	...
	void Start()
    {
        ...
        GameObject building = GameObject.Instantiate(Resources.Load("Buildings/" + _theme + "_Base"), transform.position, Quaternion.Euler(new Vector3(-90, 90 + transform.rotation.eulerAngles.y, 0))) as GameObject;
